            ...
            <div key={req.id} className="bg-white p-5 rounded-3xl shadow-sm border border-gray-100 space-y-4">
              <div className="flex justify-between items-start">
                ...
                <span className={`px-3 py-1 rounded-full text-[10px] font-bold ${
                  req.priority === 'Emergency' ? 'bg-red-100 text-red-600' : 
              ...
              <div className="flex space-x-3 pt-2">
                <button 
                  ...
                  className="flex-1 bg-green-500 hover:bg-green-600 text-white font-bold py-3 rounded-2xl flex items-center justify-center space-x-2 transition-all active:scale-95"
                >
